...
@implementation YCOpenPushController
- (void)viewDidLoad {
    [super viewDidLoad];
    self.tableView.contentInset = UIEdgeInsetsMake(0, 0, 0, 0);
    // 创建第一个组模型
    YCSettingItemArrow *item1=[YCSettingItemArrow itemWithTitle:@"品种百科" subTitle:@"宠物品种百科" icon:@"fy_neighbourhood_sift_all" destVc:[YCPctVarieties class]];
