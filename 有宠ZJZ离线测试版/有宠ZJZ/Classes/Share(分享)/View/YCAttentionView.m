...
@interface YCAttentionView () <UITableViewDataSource,UITableViewDelegate>
@property (nonatomic,strong) NSArray *statuses;
@property (nonatomic,weak) CZStatuseCell *cell;
@end

@implementation YCAttentionView

+ (instancetype)attentionView
{
    YCAttentionView *attentionView=[[YCAttentionView alloc]init];
    attentionView.frame=CGRectMake(screenW, 0, screenW, screenH);
    attentionView.contentInset=UIEdgeInsetsMake(0, 0, 110, 0);
    attentionView.dataSource=attentionView;
    attentionView.delegate=attentionView;
